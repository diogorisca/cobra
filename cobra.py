...
class COBRA:
    def __init__(self):
        ...
        self.cabeca_cima = pygame.image.load('imagens/cabeca_cima.png').convert_alpha()
        self.cabeca_baixo = pygame.image.load('imagens/cabeca_baixo.png').convert_alpha()
        self.cabeca_esquerda = pygame.image.load('imagens/cabeca_esquerdo.png').convert_alpha()
        self.cabeca_direita = pygame.image.load('imagens/cabeca_direito.png').convert_alpha()

        self.cauda_cima = pygame.image.load('imagens/cauda_cima.png').convert_alpha()
        self.cauda_baixo = pygame.image.load('imagens/cauda_baixo.png').convert_alpha()
        self.cauda_esquerda = pygame.image.load('imagens/cauda_esquerdo.png').convert_alpha()
        self.cauda_direita = pygame.image.load('imagens/cauda_direito.png').convert_alpha()

        self.corpo_horizontal = pygame.image.load('imagens/corpo_horizontal.png').convert_alpha()
        self.corpo_vertical = pygame.image.load('imagens/corpo_vertical.png').convert_alpha()

        self.corpo_bl = pygame.image.load('imagens/corpo_dobra_bl.png').convert_alpha()
        self.corpo_br = pygame.image.load('imagens/corpo_dobra_br.png').convert_alpha()
        self.corpo_tl = pygame.image.load('imagens/corpo_dobra_tl.png').convert_alpha()
        self.corpo_tr = pygame.image.load('imagens/corpo_dobra_tr.png').convert_alpha()

        self.som_comer = pygame.mixer.Sound('audio/comer.wav')
        self.som_morreu = pygame.mixer.Sound('audio/game_over.mp3')
...
relva = pygame.image.load('imagens/fundo.jpg').convert()
fruta = pygame.image.load('imagens/apple.png').convert_alpha()
fruta_small = pygame.transform.scale(fruta, (20, 20))
fim = pygame.image.load('imagens/game_over.png').convert_alpha()
fim_ret = fim.get_rect(center = (comprimento/2, altura/2))

fonte = pygame.font.Font('fonte/Violet-Smile.ttf', 30)
